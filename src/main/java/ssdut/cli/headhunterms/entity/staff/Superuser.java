...
public class Superuser extends Leader {
  ...
  public void modifyStaffInfo() {
    ...
    System.out.print("Enter new age (18 ~ 65) (Please enter N if you don't want to change it) : ");
    temp_input = input.nextLine();
    ...
    String update_clause = "UPDATE Employee SET id=?, name=?, sex=?, age=?, password=? WHERE id=?";
    List<String> parameters =
        List.of(
            new_id, new_name, new_sex.name(), String.valueOf(new_age), new_password, staff.getId());
  ...
  public void updateSales() {
    ...
    List<String> leader_ids =
        Factory.getFactory().getAttributes(select_clause, parameters).stream()
            .map(Object::toString)
    ...
    for (String leader_id : leader_ids) {
      ...
      int member_count = (Integer) Factory.getFactory().getAttribute(select_clause, parameters);
  ...
  public void updateTheProjectInfo() {
    ...
    System.out.print("Enter new leader's ID (Please enter N if you don't want to change it) : ");
    temp_input = input.nextLine();
    ...
    List<String> parameters =
        List.of(
            new_code_a,
            new_code_b,
            new_start.format(Project.getDateFormatter()),
