...
public class EmployeeMenu {
  ...
  private void firstMenu(Employee user) {
    ...
    do {
      ...
      List<String> menu =
          List.of("1. Personal related operations", "2. Project-related operations", "0. Exit");
  ...
  private void secondMenu(Employee user, int first_selection) {
    ...
    if (first_selection == 1) {
      ...
      do {
        MethodSet.clearScreen();
        List<String> menu = List.of("1. Check project information", "0. Back to the parent menu");
        System.out.print(MethodSet.formatMenu(menu));
        System.out.println();
        System.out.println();
        System.out.print("Enter selection: ");
