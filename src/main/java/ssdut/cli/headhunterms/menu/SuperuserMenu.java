...
public class SuperuserMenu {
  ...
  private void firstMenu(Superuser user) {
    ...
    do {
      ...
      List<String> menu =
          List.of("1. Staff management", "2. Team management", "3. Project management", "0. Exit");
  ...
  private void secondMenu(Superuser user, int first_selection) {
    ...
    if (first_selection == 1) {
      do {
        ...
        List<String> menu =
            List.of(
                "1. Change account password", "2. Modify staff information",
      ...
      do {
        ...
        List<String> menu =
            List.of(
                "1. Create new team",
                "2. Change position in the team",
                "3. Transfer of staff in the team",
      ...
      do {
        ...
        List<String> menu =
            List.of(
                ...
                "2. Delete specified project record",
                "3. Check all project information",
                "4. Check specified project information",
                "5. Update specified project information",
                "6. Update specified project status",
                "0. Back to the parent menu");
        System.out.print(MethodSet.formatMenu(menu));
        System.out.println();
        System.out.println();
