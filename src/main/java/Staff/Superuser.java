...
public class Superuser extends Leader implements Staff_Related, Project_Related {
    public Superuser(String name, Sex sex, int age, String id, String leader_id, Position position, double sales,
